...
struct SpriteMenuFrame : public uiFrame
{
	...
	void onExportButtonClick()
	{
		...
		// R G B
		// END FILE
		SerialBT.write("P3 4 4 255 0 0 0 255 0 0 0 255 0 255 255 0 0 0 255 255 0 255 0 255 255 255 255 255 0 0 0 255 0 0 0 255 0 255 255 0 0 0 255 255 0 255 0 255 255 255 255 255", 154);
	}
